package examples.MultiView_Offscreen;

import newpeasy.PeasyCam;
import processing.core.PApplet;
import processing.core.PGraphics;

public class MultiView_Offscreen extends PApplet {
	...
	public void draw() {
		...
		for (int i = 0; i < cameras.length; i++) {
			...
			image(cameras[i].getCanvas(), viewport[0], viewport[1], viewport[2],
					viewport[3]);
		}
	}
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { MultiView_Offscreen.class.getName() });
	}
