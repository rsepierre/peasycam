...
camera.move(double dx, double dy, double dz) // move the looked-at point relative to current orientation in 3D.
camera.pushIn(double distance) // moves the looked-at point forward relative to current orientation.
camera.pushOut(double distance) // moves the looked-at point backwards relative to current orientation.
